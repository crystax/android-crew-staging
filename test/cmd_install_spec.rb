...
describe "crew install" do
  ...
  context "existing formula with one release and bad sha256 sum of the downloaded file" do
    it "outputs error message" do
      ...
      expect(pkg_cache_in?(:target, 'libbad', '1.0.0', 1)).to eq(true)
    end
  end
  ...
  #                       "checking integrity of the archive file #{file}\n" \
  #                       "unpacking archive\n")
  #     expect(pkg_cache_in?(:target, 'libfour', '4.4.4', 4)).to eq(true)
  #   end
  # end
  ...
  #                       "checking integrity of the archive file #{file}\n" \
  #                       "unpacking archive\n")
  #     expect(pkg_cache_in?(:target, 'libfour', '3.3.3', 3)).to eq(true)
  #   end
  # end
end
